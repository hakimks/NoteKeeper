...
public class NoteListActivityTestRecord {
    ...
    public void noteListActivityTestRecord() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.text_note_content),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.CoordinatorLayout")),
                                        1),
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.text_note_content), withText("Body"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class),
                                        1),
