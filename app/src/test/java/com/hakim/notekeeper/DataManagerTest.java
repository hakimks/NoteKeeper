...
public class DataManagerTest {
    ...
    public void createNewNote() {
        // to create a new note, we need three things, course, a note title and text
...
//        assertSame(newNote, compareNote); its not good test, its best to get individual values
